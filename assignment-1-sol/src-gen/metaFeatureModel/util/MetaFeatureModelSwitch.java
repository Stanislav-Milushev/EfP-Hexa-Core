 ...
 * @generated
 */
public class MetaFeatureModelSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static MetaFeatureModelPackage modelPackage;
	 ...
	 * @generated
	 */
	public MetaFeatureModelSwitch() {
		if (modelPackage == null) {
			modelPackage = MetaFeatureModelPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case MetaFeatureModelPackage.FEATURE_MODEL: {
		...
		case MetaFeatureModelPackage.CONSTRAINT: {
		...
		case MetaFeatureModelPackage.EXCLUDE_CONSTRAINT: {
		...
		case MetaFeatureModelPackage.REQUIRE_CONSTRAINT: {
		...
		case MetaFeatureModelPackage.FEATURE: {
		...
		case MetaFeatureModelPackage.GROUP: {
